...
export default function SingleAuction({ Images, curIndex }) {
    ...
    <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
      ...
      <div className="mt-4 flex flex-wrap gap-4 justify-between">
        ...
        <Button
          variant="contained"
          className="bidBtn"
          onClick={() => setShowModal(true)} // Open this instance's modal
        >
          Place Bid
        </Button>
        {showModal && (
          <Modal
            Images={Images}
            curIndex={curIndex}
            setPopUp={setShowModal} // Pass the local state setter to the modal
            offerBid={offerBid}
